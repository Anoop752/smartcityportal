    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3 id="Number_of_College">150</h3>
              ...
              <a href="engineering.jsp" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3  id="number_of_pg">53<sup style="font-size: 20px"></sup></h3>
              ...
              <a href="payingGuest(PG).jsp" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
        ...
        <div class="row">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="dist/img/slider1.jpg" alt="First slide"   height="250">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="dist/img/slider5.png"" alt="Second slide"  height="250">
                    </div>
                    <div class="carousel-item">
                      <img class="d-block w-100" src="dist/img/slider4.jpg" alt="Third slide" height="250">
                    </div>
                  </div>
          ...
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">About Sakasham</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div id="accordion">
                  <div class="card card-primary">
                    ...
                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                      <div class="card-body" id="college_desc">
                  ...
                  <div class="card card-danger">
                    ...
                    <div id="collapseTwo" class="collapse" data-parent="#accordion">
                      <div class="card-body" id="pg_desc">
                  ...
                  <div class="card card-success">
                    ...
                    <div id="collapseThree" class="collapse" data-parent="#accordion">
                      <div class="card-body" id="about_us">
                        Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.
                        3
                        wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt
                        laborum
        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">            
            ...
            <div class="card direct-chat direct-chat-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body" id="dsh_user_cmt">
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <div class="input-group">
                    <input type="text" id="dash_user_review" name="message" placeholder="Type Message ..." class="form-control">
                    <span class="input-group-append">
                      <button type="button" onclick="saveData()" class="btn btn-primary">Send</button>
                    </span>
                  </div>
                </form>
              </div>
...
getdashboard_header();
getdashboard();
getdashboard_comment();
getNumber_Of_College();
getNumber_Of_PG();
getNumber_Of_Unique_Visitor();
function saveData()
{
	saveUserComment();	
}
