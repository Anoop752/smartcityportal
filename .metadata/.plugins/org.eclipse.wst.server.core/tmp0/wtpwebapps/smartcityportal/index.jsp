...
<body style="background-image:url('images/loginimg2.avif')">
<div class="">
  <!-- Preloader -->
  ...
  <div class="">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
         <marquee><h1 class="m-0" style="color:red">Login</h1></marquee>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="card" style="width:100%">
        <div class="card-body row">
          ...
          <div class="col-7">
            ...
            <div class="form-group">
             <a href="dashboard.jsp"> <input type="submit" class="btn btn-primary" value="submit"></a>
            </div>
          </div>
        </div>
      </div>
